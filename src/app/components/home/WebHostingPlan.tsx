...
const WebHostingPlan = () => {
  return (
    <div className="flex flex-col items-center justify-center w-3/4 rounded p-4 bg-gray-200 mb-7 md:w-2/4 lg:w-1/4 ">
      ...
      <div className="mt-6">
        <h5 className="text-2xl mb-1 font-semibold">Top Features</h5>
        <div className="flex item-center text-green-700 mb-1 ps-3">
          <TiTick /> 100 Website
        </div>
      ...
      <button className='mt-4 border-2 border-gray-900 text-2xl font-bold p-1 rounded-full hover:text-white hover:bg-gray-900 transition w-full'>
        Buy Now
      </button>
    </div>
  );
